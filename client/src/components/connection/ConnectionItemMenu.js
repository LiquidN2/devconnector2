  ...
  render() {
    return (
      <div className="connection-item__nav connection-item__nav--show">
        ...
        <Link to={`/chat/${this.props.userId}`} className="connection-item__nav-item link--color">Send Message</Link>
        <Link to={`/profile/${this.props.userId}`} className="connection-item__nav-item link--color">View Profile</Link>
        <button 
